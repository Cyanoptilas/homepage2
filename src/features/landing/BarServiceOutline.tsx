...
function BarServiceOutline() {
  return (
    ...
    //           <Text as="h1" color="black" fontSize="32" paddingTop={10}>
    //             SmartHRひとつで、
    //           </Text>
    //           <Text as="h1" color="black" fontSize="32" paddingTop={3}>
    //             人事・労務の
    //             <Text
    //               as="span"
    ...
    //   </Flex>
    // </>
    <Flex paddingBottom="60px" overflow="hidden" backgroundColor="#f4f8f9">
      <Flex
