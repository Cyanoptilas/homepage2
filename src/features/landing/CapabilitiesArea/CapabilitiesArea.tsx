import { ButtonUsefulDocs } from "@/features/ui";
import {
  Box,
  Flex,
  Heading,
          ...
          <Box boxSizing="border-box" margin="56px auto 0">
            ...
            >
              ...
              <Flex boxSizing="border-box" flex="1">
                {/* <List flexWrap="wrap" gap="25px 20px" display="flex"> */}
    ...
    >
      ...
      >
        ...
        <Text
          ...
          margin="0 0 20px"
        >
          {label === "人事評価" ? `導入前 担当者${hours1}名 → ${hours2}名`: `導入前 ${hours1}h → ${hours2}h` }
        </Text>
      </Box>
    </Box>
  );
